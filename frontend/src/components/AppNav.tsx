import { Activity, BookOpen, ChartNoAxesCombined, LayoutDashboard, Settings, Scale } from 'lucide-react'
...
const links: Array<{
  ...
  { id: 'positions', href: '/manager/positions/', label: '仓位', icon: ChartNoAxesCombined },
