...
export type PositionHistoryAvailability =
  | 'ok'
  | 'missing_mark'
  | 'missing_anchor'
  | 'missing_equity'
...
export type CurrentEquityAvailability =
  | 'ok'
  | 'missing'
  | 'stale'
  | 'nonfinite'
...
export interface PositionHistoryCurrentEquityAccount {
  source_id: string
  equity_usdt: number | null
  ts_ms: number | null
  availability: CurrentEquityAvailability
}

export interface PositionHistoryCurrentEquity {
  equity_usdt: number | null
  availability: CurrentEquityAvailability
  accounts: PositionHistoryCurrentEquityAccount[]
}

export interface PositionHistoryPortfolioPoint {
  ts_ms: number
  equity_usdt: number | null
  gross_notional_usdt: number | null
  gross_leverage: number | null
  availability: PositionHistoryAvailability
  missing_source_ids: string[]
}

export interface PositionHistoryAccountPoint {
  ts_ms: number
  source_id: string
  equity_usdt: number | null
  gross_notional_usdt: number | null
...
export interface PositionHistorySymbolPoint {
  ts_ms: number
  source_id: string
  symbol: string
  venue: string
  quantity: number | null
  signed_notional_usdt: number | null
  gross_notional_usdt: number | null
  valuation_price: number | null
  valuation_source: 'last_fill' | 'initial_reference' | 'unavailable'
  leverage_contribution: number | null
  availability: PositionHistoryAvailability
}

export interface PositionHistorySource {
  source_id: string
  first_ts_ms: number
  last_ts_ms: number
}
...
export interface PositionHistorySnapshot {
  ...
  selected_source_ids: string[]
  selected_symbols: string[]
  available_sources: PositionHistorySource[]
  available_symbols: string[]
  leverage_basis: 'current_account_equity'
  current_equity: PositionHistoryCurrentEquity
  portfolio_points: PositionHistoryPortfolioPoint[]
  account_points: PositionHistoryAccountPoint[]
  symbol_points: PositionHistorySymbolPoint[]
}
